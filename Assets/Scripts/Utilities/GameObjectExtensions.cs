...
public static class GameObjectExtensions
{
    ...
    public static T GetResource<T>(this GameObject gameObject) where T : ScriptableObject
    {
        var locator = gameObject.GetComponent<ResourceLocator>();
        if (locator != null) return locator.Get<T>();
        Debug.LogError($"No ResourceLocator found on {gameObject.name}!", gameObject);
        return null;
    }
}